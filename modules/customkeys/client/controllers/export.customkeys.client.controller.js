...
angular.module('customkeys').controller('ExportCustomkeysController', ['$scope', '$stateParams', '$location', 'Authentication', 'Customkeys', '$http', '$q', '$window', 'Download',
  function ($scope, $stateParams, $location, Authentication, Customkeys, $http, $q, $window, Download) {
